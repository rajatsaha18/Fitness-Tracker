            ...
            <ul class="navbar-nav header-right">
                            ...
                            <ul class="timeline">
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="{{asset('website/assets')}}images/avatar/1.jpg">
                                        </div>
                                ...
                                <li>
                                 ...
                                 <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="images/avatar/1.jpg___/div__div%20class%3d.html"media-body">
                                            <h6 class="mb-1">Dr sultads Send you Photo</h6>
                                            <small class="d-block">29 July 2020 - 02:26 PM</small>
                                        </div>
                                    </div>
                ...
                <li class="nav-item dropdown header-profile">
                    <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                        <img src="{{asset('website/assets/images/profile/17.jpg')}}" width="20" alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="page-login.html" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();" class="dropdown-item ai-icon">
