        ...
        <div class="card">
            <div class="card-header flex-wrap pb-0 border-0">
                ...
                <div class="d-flex me-3 me-sm-4 mb-2">
                    <svg class="me-2 mt-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="featured-menus owl-carousel">
                            <div class="items">
                                <div class="d-sm-flex p-3 border border-light rounded">
                                    <a href="ecom-product-detail.html"><img class="me-4 food-image rounded" src="{{asset('website/assets/images/menus/3.png')}}" alt="" width="160"></a>
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="rounded-circle me-2 profile-image" src="{{asset('website/assets/images/testimonial/3.jpg')}}" alt="" width="30">
                            ...
                            <div class="items">
                                <div class="d-sm-flex p-3 border border-light rounded">
                                    <a href="ecom-product-detail.html"><img class="me-4 food-image rounded" src="{{asset('website/assets/images/menus/1.png')}}" alt="" width="160"></a>
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="rounded-circle me-2 profile-image" src="{{asset('website/assets/images/testimonial/1.jpg')}}" alt="" width="30">
                            ...
                            <div class="items">
                                <div class="d-sm-flex p-3 border border-light rounded">
                                    <a href="ecom-product-detail.html"><img class="me-4 food-image rounded" src="{{asset('website/assets/images/menus/2.png')}}" alt="" width="160"></a>
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="rounded-circle me-2 profile-image" src="{{asset('website/assets/images/testimonial/2.jpg')}}" alt="" width="30">
